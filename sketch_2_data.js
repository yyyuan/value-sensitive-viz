...
function setup() {
  ...
  // need to modify for new data set
  thresholdRange1 = 33;
  thresholdRange2 = 38;
  //
...
function draw() {
  ...
  //
    ...
    if(currentType == 1){
      document.getElementById("summary-1-data").innerHTML = 3000
      document.getElementById("disparity-formula").innerHTML = " max ( |FP<sub>African American</sub> - FP<sub>White American</sub>| , |FN<sub>African American</sub> - FN<sub>White American</sub>| )";
    } else if (currentType == 2) {
      document.getElementById("summary-1-data").innerHTML = 1600;
      document.getElementById("disparity-formula").innerHTML = " max ( |FP<sub>Female</sub> - FP<sub>Male</sub>| , |FN<sub>Female</sub> - FN<sub>Male</sub>| )";
    }
...
function buttonScenarioEvent(){
  ...
  //view = 1;
  //window.open("explore_2_scenario.html",'_self');
}
